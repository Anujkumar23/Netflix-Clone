...
import NetflixLogo from "../assets/Netflix_Logo.png";
  ...
  return (
    <>
      ...
      <main>
        <section className='  absolute top-0 min-h-screen w-full bg-[url("Netflix_cover.jpg")] bg-cover'>
          <section className="  from- absolute inset-0 bg-zinc-900/50 bg-gradient-to-b"></section>
        </section>

        <form onSubmit={onHandleSubmit} className=" relative mx-auto w-[350px] rounded-sm bg-dark/75 p-14">
          <article className="overflow-hidden">
            <h1 className="mb-4 p-2 text-3xl ">SignUp</h1>
    ...
    "
            ...
            <section>
              <p>Already have an account?{' '}<Link className="underline cursor-pointer" to="/Login">sign In</Link> </p>
            </section>
          </article>
        </form>
      </main>
